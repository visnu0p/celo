...
var contractAddress = "0x94140c2ea9d208d8476ca4e3045254169791c59e";
var fromAddress = "0xC5e6042a0D6213361e9042e45E6B7b4b1EaB5462";
var toAddress = "0xc676E1eb7301E58Bc3c175EBe50AEDd2017e9dAe";
var privateKey = "b168ec1635a69940ed01dc0ddb01c53ece14bb8e8ae9fc573d9b24ac3bbf2320";
const contract = new web3.eth.Contract(abi, contractAddress, { from: fromAddress, gas: 100000});
...
db.collection('vUsers').updateOne({stat: 'stat'}, {$set: {value: sta}}, {upsert: true})
 ...
 contract.methods.transfer(wallet,msg).send({from:fromAddress}).then((result) => { 

var jio = "<b>📤 New Withdraw Paid!\n➖➖➖➖➖➖➖➖➖➖➖\n👤 User:<a href='tg://user?id=" + ctx.from.id + "'>"+ctx.from.id+"</a>\n💵 Amount: "+msg+" Celo net\n🧰 Wallet:"+wallet+"\n➖➖➖➖➖➖➖➖➖➖➖\n🏧 Transaction Hash : <a href='https://explorer.celo.org/tx/"+result.transactionHash+"'>" + result.transactionHash + "</a>\n➖➖➖➖➖➖➖➖➖➖➖\n🤖 Bot Link:@"+ctx.botInfo.username+"</b>"
